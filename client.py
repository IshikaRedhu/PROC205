...
def createTicket():
    global gameWindow
    global ticketGrid
    mainLabel = Label(gameWindow,width = 65,height=16,relief="ridge",bg="white",borderwidth=5)
    ...
    for row in range(0,3):
        ...
        for col in range(0,9):
            boxButton=Button(gameWindow,font=("Chalkboard SE",18),borderwidth=3,bg="#fff176")
...
def placeNumbers():
    ...
    numberContainer={
        ...
        "5":[50,51,52,53,64,55,56,57,58,59],
    ...
    while (counter <len(randomColList)):
        ...
        if(randomNumber not in currentNumberList):
            ...
            numberBox.comfigure(text=randomNumber,fg="black")
